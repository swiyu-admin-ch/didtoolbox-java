...
class DidLogMetaPeekerTest {
    ...
    static {
        ...
        try {
            ...
            VERIFICATION_METHOD_KEY_PROVIDER = new Ed25519VerificationMethodKeyProviderImpl(new FileInputStream("src/test/data/mykeystore.jks"), "changeit", "myalias", "changeit");
    ...
    private static String buildInitialDidLogEntry() {
        try {
            return TdwCreator.builder()
                    ...
                    .build()
                    .create(URL.of(new URI("https://identifier-reg.trust-infra.swiyu-int.admin.ch/api/v1/did/18fa7c77-9dd1-4e20-a147-fb1bec146085"), null), ZonedDateTime.parse("2012-12-12T12:12:12Z"));
        } catch (Exception intolerable) {
            throw new RuntimeException(intolerable);
        }
    }
