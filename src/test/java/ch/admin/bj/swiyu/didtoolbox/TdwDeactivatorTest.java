...
"""},
    ...
    private static void assertDeactivatedDidLogEntry(String didLogEntry) {
        ...
        assertEquals(1, params.size()); // no other than "deactivated"
    ...
    void testDeactivateWithKeyChangeUsingExistingUpdateKey() {
        ...
        assertTrue("""
                ...
                ["2-QmQhSEipnd6YBBMertXEfGt6hE5oPXrms1KD5Q34PMrpiC","2012-12-12T12:12:13Z",{"deactivated":true},{"value":{"@context":["https://www.w3.org/ns/did/v1","https://w3id.org/security/jwk/v1"],"id":"did:tdw:QmSWR3nK8TG6bcymMqtHGihkvtisEz4nMh7qcNEwWp4b8K:identifier-reg.trust-infra.swiyu-int.admin.ch:api:v1:did:18fa7c77-9dd1-4e20-a147-fb1bec146085"}},[{"type":"DataIntegrityProof","cryptosuite":"eddsa-jcs-2022","created":"2012-12-12T12:12:13Z","verificationMethod":"did:key:z6MkvdAjfVZ2CWa38V2VgZvZVjSkENZpiuiV5gyRKsXDA8UP#z6MkvdAjfVZ2CWa38V2VgZvZVjSkENZpiuiV5gyRKsXDA8UP","proofPurpose":"authentication","challenge":"2-QmQhSEipnd6YBBMertXEfGt6hE5oPXrms1KD5Q34PMrpiC","proofValue":"zQmgvLu1i6gTYxQog4VETiigDbr11wPFvy1A8aCybxJSjfyQWxhY6X7fFNGMqEwrzmWDavDc5VbevCPnXKzFQ3UC"}]]
    ...
    void testUpdateWithKeyChange(String privateKeyMultibase, String publicKeyMultibase, String publicKeyPem) {
        ...
        assertDeactivatedDidLogEntry(nextLogEntry);
