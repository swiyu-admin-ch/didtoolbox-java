...
class RandomEd25519KeyStore {
     ...
     */
    static UpdateKeysDidMethodParameter asUpdateKeysDidMethodParameter() {
     ...
     */
    static NextKeyHashesDidMethodParameter asNextKeyHashesDidMethodParameter() {
     ...
     */
    static VcDataIntegrityCryptographicSuite asCryptographicSuite() {
